...
| `displays`    | List monitors / set scale / `primary <name>` to resize shadow to monitor / enable / disable |
| `face`        | Show / set this turtle's world facing for nav.lib (`face 0..3` or `face +x`/`+z`/`-x`/`-z`) |
